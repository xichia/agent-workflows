...
The Antigravity workflow uses these terms:
...
- [OpenCode Go Router Process: Manager and Specialist Workflow](workflows/opencode-go-router-workflow.md) — replaces a manual multi-model copy-and-paste process with a repo-local OpenCode Go manager that routes work to specialist agents. Use it when you want planning, implementation, debugging, review, and documentation roles through one OpenCode Go subscription.
